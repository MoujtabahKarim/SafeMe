    ...
    insertFundementalNumbers()
        ...
        var numOfCapitalCase = 3 ; 
         ...
         for(var i = 0; i < password.length; i++) {
            ...
            //random number returned matches the number in the password then replace with special character 
            ...
            // Inserting lower case into the generator 
            if(!SpecialCharacter && numOfLowerCase > 0) {
                password[i] = character[getRandomNumber(character.length)] ;
                numOfLowerCase-- ; 
            }

            //It'll never be less than 0 bud we add this in for good programming practise 
